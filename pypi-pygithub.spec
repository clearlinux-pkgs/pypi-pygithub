...
Source0  : https://files.pythonhosted.org/packages/16/ce/aa91d30040d9552c274e7ea8bd10a977600d508d579a4bb262b95eccf961/pygithub-2.5.0.tar.gz
...
%prep
%setup -q -n pygithub-2.5.0
cd %{_builddir}/pygithub-2.5.0
pushd ..
cp -a pygithub-2.5.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1730938544
...
cp %{_builddir}/pygithub-%{version}/tests/License.py %{buildroot}/usr/share/package-licenses/pypi-pygithub/c2f079516871b897b92f6888e7241286332710cd || :
...
cp %{_builddir}/pygithub-%{version}/tests/ReplayData/License.setUp.txt %{buildroot}/usr/share/package-licenses/pypi-pygithub/4f5496762ff92cd314ec7e27b110f208d66928c6 || :
...
/usr/share/package-licenses/pypi-pygithub/4f5496762ff92cd314ec7e27b110f208d66928c6
/usr/share/package-licenses/pypi-pygithub/8624bcdae55baeef00cd11d5dfcfa60f68710a02
/usr/share/package-licenses/pypi-pygithub/c2f079516871b897b92f6888e7241286332710cd
