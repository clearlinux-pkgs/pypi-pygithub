...
Source0  : https://files.pythonhosted.org/packages/c0/88/e08ab18dc74b2916f48703ed1a797d57cb64eca0e23b0a9254e13cfe3911/pygithub-2.6.1.tar.gz
...
%prep
%setup -q -n pygithub-2.6.1
cd %{_builddir}/pygithub-2.6.1
pushd ..
cp -a pygithub-2.6.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1740150627
...
cp %{_builddir}/pygithub-%{version}/tests/License.py %{buildroot}/usr/share/package-licenses/pypi-pygithub/4890df83400284ff1321ea8f2b4ed122b2a1813f || :
...
cp %{_builddir}/pygithub-%{version}/tests/ReplayData/License.setUp.txt %{buildroot}/usr/share/package-licenses/pypi-pygithub/c96b219c52e86eba5b0a13a9dafc06485c85a687 || :
...
/usr/share/package-licenses/pypi-pygithub/4890df83400284ff1321ea8f2b4ed122b2a1813f
...
/usr/share/package-licenses/pypi-pygithub/c96b219c52e86eba5b0a13a9dafc06485c85a687
