...
Source0  : https://files.pythonhosted.org/packages/98/a8/ceb6f51d2fff91ce4a670218c2aa9bff44f05f541ba7e1ccc632c2751f5b/PyGithub-2.2.0.tar.gz
...
%prep
%setup -q -n PyGithub-2.2.0
cd %{_builddir}/PyGithub-2.2.0
pushd ..
cp -a PyGithub-2.2.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1706632357
