...
Source0  : https://files.pythonhosted.org/packages/5c/fb/3af782cd3c0f2c19bc54c640af33513369d240ca748f39c0b38b371e5d1d/PyGithub-2.3.0.tar.gz
...
%prep
%setup -q -n PyGithub-2.3.0
cd %{_builddir}/PyGithub-2.3.0
pushd ..
cp -a PyGithub-2.3.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711313863
